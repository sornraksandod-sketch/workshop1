...
try:
    kmeans_loaded = joblib.load("kmeans_redbull.pkl") # โหลดโมเดล K-Means ที่ถูก train ไว้แล้ว
    scaler_loaded = joblib.load("scaler_redbull.pkl")   # โหลด Scaler ที่ถูก train ไว้แล้ว สำหรับการทำ Preprocessing
